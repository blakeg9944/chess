...
public class SQLGameDAO implements GameDAO {
    ...
    public int createGame(String gameName) throws DataAccessException {
        // Remove the manual increment: sqlGameInt += 1;
        String statement = "INSERT INTO games (whiteUsername, blackUsername, gameName, game) VALUES (?, ?, ?, ?)";

        try (Connection con = DatabaseManager.getConnection()) {
            // Ask JDBC to return the ID generated by the database
            try (PreparedStatement preparedStatement = con.prepareStatement(statement, java.sql.Statement.RETURN_GENERATED_KEYS)) {
